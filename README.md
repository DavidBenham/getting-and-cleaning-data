...
The purpose of this project is to fulfill the requirements of the course Getting and Cleaning Data Course project:
...
## Implementation
To fulfill the requirements, the **run_analysis.R** script includes the following steps:
